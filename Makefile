...
ERLC=erlc
ERL=erl
ERL_FLAGS=-smp enable -pa apps/logger/ebin -pa apps/utils/ebin -pa apps/listener/ebin -pa apps/rtsp/ebin -pa apps/ems/ebin -pa apps/utils/test -pa apps/ems/test -pa apps/rtp/ebin
